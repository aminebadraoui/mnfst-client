...
const BusinessFlow = () => {
    return (
        <div className="h-full m-8 py-20 flex flex-col items-center justify-center gap-12 bg-gray-950">
            ...
            <motion.div className="w-full max-w-4xl">
                <h2 className="text-3xl font-bold text-center mb-8 bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">
                    Direct to your AI-Powered Website
                </h2>
            ...
            <motion.div className="w-full max-w-4xl">
                <h2 className="text-3xl font-bold text-center mb-8 bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">
                    Capture the Lead into your Funnel
                </h2>
                <div className="flex justify-between px-[20%] bg-white/5 backdrop-blur-sm rounded-xl p-8">
                    <motion.div
                        className="flex flex-col items-center gap-3"
                        whileHover={{ scale: 1.05 }}
                    >
                    ...
                    >
                        ...
                        <span className="text-gray-400">Free Ebook</span>
                    </motion.div>
                </div>
            </motion.div>
        </div>
